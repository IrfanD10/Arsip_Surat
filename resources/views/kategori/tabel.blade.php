                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 text-center">
                    ...
                    <td class="px-6 py-4">
                        <div class="inline-flex">                                            
                            <a href="{{ route('kategori.edit', ['kategori'=>$data->id_kategori]) }}" class="flex items-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg px-3 me-2 my-1 py-1.5 dark:focus:ring-yellow-900">
